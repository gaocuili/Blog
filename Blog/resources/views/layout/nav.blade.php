<div class="blog-masthead">
    <div class="container">
        <ul class="nav navbar-nav navbar-left">
            ...
            <li>
                <input name="query" type="@if(!empty($query)){{$query}}@endif" value="" class="form-control" style="margin-top:10px" placeholder="搜索词">
            </li>
            <li>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
                <div>
                    <img src="/image/cat.png" alt="" class="img-rounded" style="border-radius:500px; height: 30px">
